...
# ── Model embeddingowy ────────────────────────────────────────────
# stella-pl-retrieval-8k: dim=1024, NDCG@10=62.69 na PIRB, kontekst 8192 tokenów
# Wymaga prefiksu dla zapytań (nie dla dokumentów):
...
QUERY_STOPWORDS = {
    ...
    "a", "że", "się", "nie", "być", "który", "które", "która",
}
...
TAXONOMY_STATIC: dict[str, list[str]] = {
    ...
    "term_sector": [
        "BIP", "DODO", "Finanse", "Marketing", "Mieszkalnictwo",
        "Monitoring", "Pozostałe", "Szkolnictwo", "Telekomunikacja",
        "Ubezpieczenia", "Zatrudnienie", "Zdrowie",
    ],
    "term_corrective_measure": [
        "ostrzeżenie", "upomnienie", "nakaz spełnienia żądania",
        "dostosowanie", "poinformowanie", "ograniczenie przetwarzania",
